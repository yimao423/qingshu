  ...
  _renderPage(page) {
    switch (page) {
      ...
      case 'survey-answer':
        ...
        break;
      case 'bubble-maker':
        window.renderBubbleMaker && window.renderBubbleMaker();
        break;
      case 'bubble-shop':
