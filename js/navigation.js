...
const Navigation = {
  ...
  // 页面列表
  pages: ['home', 'chat-list', 'chat-room', 'wordcard', 'wordcard-quotes', 'wordcard-main', 'wordcard-main-group', 'wordcard-kaomoji', 'wordcard-kaomoji-group', 'wordcard-pat', 'wordcard-pat-group', 'wordcard-emoji', 'wordcard-emoji-group', 'wordcard-stickers', 'wordcard-stickers-group', 'wordcard-daily-quotes', 'discover', 'moments', 'moments-publish', 'moments-visitors', 'mailbox', 'write-letter', 'mailbox-reply', 'mailbox-detail', 'mailbox-settings', 'whereabout-settings', 'daily-record', 'whereabouts', 'whereabout-group', 'whereabout-reports', 'settings', 'account-settings', 'appearance', 'chat-settings', 'feature-settings', 'pace-settings', 'sound-settings', 'data-manage', 'about', 'period', 'shop', 'shop-cart', 'survey', 'survey-answer', 'bubble-shop'],
