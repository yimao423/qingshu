  ...
  _renderPage(page) {
    switch (page) {
      ...
      case 'love-test':
        ...
        break;
      case 'daily-sweet':
        window.renderDailySweet && window.renderDailySweet();
        break;
      case 'love-fortune':
        window.renderLoveFortune && window.renderLoveFortune();
        break;
      case 'love-match':
        window.renderLoveMatch && window.renderLoveMatch();
        break;
      case 'bubble-shop':
