...
const Navigation = {
  ...
  // 页面列表
  pages: ['home', 'chat-list', 'chat-room', 'wordcard', 'wordcard-quotes', 'wordcard-main', 'wordcard-main-group', 'wordcard-kaomoji', 'wordcard-kaomoji-group', 'wordcard-pat', 'wordcard-pat-group', 'wordcard-emoji', 'wordcard-emoji-group', 'wordcard-stickers', 'wordcard-stickers-group', 'wordcard-daily-quotes', 'discover', 'moments', 'mailbox', 'write-letter', 'daily-record', 'settings', 'account-settings', 'appearance', 'chat-settings', 'feature-settings', 'pace-settings', 'sound-settings', 'data-manage', 'about', 'album', 'album-detail', 'period', 'treehole', 'music', 'novel', 'novel-reader', 'notepad', 'notepad-editor', 'shop', 'shop-cart', 'survey', 'survey-answer'],
  ...
  _renderPage(page) {
    switch (page) {
      ...
      case 'data-manage':
        ...
        break;
      case 'album':
        window.renderAlbum && window.renderAlbum();
        break;
      case 'album-detail':
        window.renderAlbumDetail && window.renderAlbumDetail();
        break;
      case 'period':
        window.renderPeriod && window.renderPeriod();
        break;
      case 'treehole':
        window.renderTreehole && window.renderTreehole();
        break;
      case 'music':
        window.renderMusic && window.renderMusic();
        break;
      case 'novel':
        window.renderNovel && window.renderNovel();
        break;
      case 'notepad':
        window.renderNotepad && window.renderNotepad();
        break;
      case 'shop':
      ...
      case 'shop-cart':
        ...
        break;
      case 'survey':
        window.renderSurvey && window.renderSurvey();
        break;
      case 'survey-answer':
        window.renderSurveyAnswer && window.renderSurveyAnswer();
        break;
    }
  },
