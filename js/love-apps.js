...
(function () {
  ...
  window.MoodFlowApp = {
    ...
    renderTags: function () {
      ...
      // 左侧：情绪种类分类栏（recipe-sb-item，色点作图标，间距对标商城/菜谱/科普）
      ...
      // 左侧底部：自定义添加入口（对齐商城 shop-sb-add / 菜谱 sep+入口）
      var sbAdd = '<div class="recipe-sidebar-sep"></div>'
        + '<button class="mood-sb-add" onclick="MoodFlowApp.openAddModal()"><i class="fas fa-plus"></i><span>添加</span></button>';
      ...
      return '<div class="recipe-shell">'
        + '<div class="recipe-sidebar">' + sbItems + sbAdd + '</div>'
