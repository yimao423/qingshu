...
var ChatMedia = {
  ...
  collectMsgMedia: function(msg, mediaMap, seqBox) {
    var self = this;
    var jobs = [];
  ...
  prepareExportMessages: function(messagesObj, mediaMap, seqBox) {
    var self = this;
    var jobs = [];
    Object.keys(messagesObj).forEach(function(cid) {
      ...
      list.forEach(function(msg) {
        if (!msg) return;
        jobs.push(self.collectMsgMedia(msg, mediaMap, seqBox));
      });
    });
    return Promise.all(jobs);
  },
