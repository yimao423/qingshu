...
function openPatPanel(mode, presetText) {
  ...
  presetPats.forEach(function(p) {
    ...
    presetHtml += '<div class="pat-preset-card" data-text="' + Core.escapeHtml(p.text) + '">'
  ...
  if (presetList) {
    presetList.addEventListener('click', function(e) {
      ...
      if (!item) return;
      var tpl = item.getAttribute('data-text') || '';
...
var PUNISH_ICON_SVG = '<svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" width="14" height="14"><path d="M7 12 L7 18 L11.2 18 L19.6 23.8 C20.6 24.5 21.8 23.7 21.8 22.4 L21.8 7.6 C21.8 6.3 20.6 5.5 19.6 6.2 L11.2 12 Z" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"/><path d="M11.4 18.6 C11.4 20.8 10.2 22.4 8.4 22.4" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round"/><path d="M25 10.6 C26.4 12.6 26.4 17.4 25 19.4" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round"/><path d="M28.4 7.8 C30.6 11.4 30.6 18.6 28.4 22.2" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round"/></svg>';
