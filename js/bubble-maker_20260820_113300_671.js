var BubbleMaker = (function() {
  ...
  function bindMakerEvents() {
    ...
    // 四角圆角
    bindRangeNumber('bm-radius-tl', 'bm-radius-tl-num', null, function(v) { _state.radiusTL = v; refreshPreview(); });
    bindRangeNumber('bm-radius-tr', 'bm-radius-tr-num', null, function(v) { _state.radiusTR = v; refreshPreview(); });
    bindRangeNumber('bm-radius-bl', 'bm-radius-bl-num', null, function(v) { _state.radiusBL = v; refreshPreview(); });
    bindRangeNumber('bm-radius-br', 'bm-radius-br-num', null, function(v) { _state.radiusBR = v; refreshPreview(); });
    // 晕染
  ...
  function syncFormFromState() {
    ...
    setVal('bm-radius-tl', 'bm-radius-tl-num', null, _state.radiusTL);
    setVal('bm-radius-tr', 'bm-radius-tr-num', null, _state.radiusTR);
    setVal('bm-radius-bl', 'bm-radius-bl-num', null, _state.radiusBL);
    setVal('bm-radius-br', 'bm-radius-br-num', null, _state.radiusBR);
